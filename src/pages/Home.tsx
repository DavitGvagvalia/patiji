  ...
  return (
    <>
      <section className="bg-white">
        <div className="mx-auto grid max-w-7xl gap-9 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1fr_0.82fr] lg:px-8 lg:py-20">
          <div className="flex flex-col justify-center">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-gold">
              {content.home.eyebrow}
            </p>
            <h1 className="mt-5 max-w-4xl text-4xl font-semibold leading-tight tracking-tight text-brand-navy sm:text-6xl sm:leading-[1.05] lg:text-7xl">
              {content.home.headline}
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-8 text-brand-black/72 sm:text-lg">{content.home.intro}</p>
